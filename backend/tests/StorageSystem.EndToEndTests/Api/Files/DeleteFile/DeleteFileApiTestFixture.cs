...
[CollectionDefinition(nameof(DeleteFileApiTestFixture))]
public class DeleteFileApiTestFixtureCollection : ICollectionFixture<DeleteFileApiTestFixture> { }

public class DeleteFileApiTestFixture : BaseFixture
{
